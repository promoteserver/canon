...
$sqlfp = "SELECT product FROM feature ORDER BY id DESC LIMIT 0 , 3"; // select 3 featured products.
...
{
	$sql= "SELECT * FROM photos where idsec='".$fp['fid']."' order by id asc";
	$result= mysql_query($sql);

	while ($row = mysql_fetch_array($result))
	{
		echo ' <div class="col-xs-6 col-sm-4 col-lg-3 top20 col-xxs-12 text-center"> 
<a href="#" class="col-img"><img src="images/products_img/'.$row['small'].'" width="250" height="150" align="bottom" class="img-border img-responsive" ><p class="lead">French Louis XV Bureau Du Roi Roll Top Desk Inlay </p></a>
</div>';
	}
} 
